...
<figure class="iframe-wrapper">
	      <iframe src="http://www.daazo.com/embed/5698ae82-910e-102c-a455-000e2e531ae0?large&width=640&height=360" frameborder="0" width="640" height="360" allowfullscreen="true">
	      </iframe> 
</figure>
<label for="mn-nyitany-movie" class="margin-toggle">&#8853;</label><input type="checkbox" id="mn-nyitany-movie" class="margin-toggle"/><span class="marginnote">Use the [YouTube link](https://www.youtube.com/watch?v=F8yuDPNjjWA) if the video does not start. 
</span>
